...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        <li><a class="app-menu__item" href="{{route('admin')}}"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Dashboard</span></a></li>

        <li><a class="app-menu__item  {{Request::is('brands')? 'active':''}}" href="{{route('brands.index')}}">
                <i class="app-menu__icon fa fa-area-chart"></i>
                <span class="app-menu__label">Brands</span></a></li>

        <li><a class="app-menu__item  {{Request::is('categories')? 'active':''}}" href="{{route('categories.index')}}">
                <i class="app-menu__icon fa fa-bar-chart"></i>
                <span class="app-menu__label">Categories</span>
            </a></li>

        <li><a class="app-menu__item  {{Request::is('subcategories')? 'active':''}}" href="{{route('subcategories.index')}}">
        ...
        <li>
            <a class="app-menu__item  {{Request::is('items')? 'active':''}}" href="{{route('items.index')}}">
                <i class="app-menu__icon fa fa-retweet">

                </i><span class="app-menu__label">Items</span></a>
        </li>
          <li>
              <a class="app-menu__item  {{Request::is('orders')? 'active':''}}" href="{{route('orders.index')}}">
                  <i class="app-menu__icon fa fa-area-chart">

                  </i><span class="app-menu__label">Orders</span></a>
          </li>
